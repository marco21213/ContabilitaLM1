...
class XMLParser:
    ...
    def load_config(self) -> configparser.ConfigParser:
        ...
        # Torna indietro di una directory (dalla cartella scripts alla root del progetto)
    ...
    def extract_basic_data(self, file_path: str) -> Optional[Dict]:
        ...
        try:
            ...
            soggetto = tree.findtext(".//CessionarioCommittente/DatiAnagrafici/Anagrafica/Denominazione")
        
            if not soggetto or soggetto.strip() == "":
                # Se Denominazione non esiste, concatena Cognome + Nome
                cognome = tree.findtext(".//CessionarioCommittente/DatiAnagrafici/Anagrafica/Cognome", default="")
                nome = tree.findtext(".//CessionarioCommittente/DatiAnagrafici/Anagrafica/Nome", default="")

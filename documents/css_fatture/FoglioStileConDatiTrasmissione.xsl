    ...
    <xsl:if test="$TipoFattura">
      ...
      <div id="fattura-elettronica" class="page">
        ...
        <xsl:if test="$TipoFattura/FatturaElettronicaHeader">			
          ...
          <!--Paolo Guccini-->
          <table class="tbTitolo" style="font-size:150;">
            <thead>
              <tr >
                <th >
                  <label class= "headerLabel" >Form.Trasm:&#160;</label>
                  <span >
                    <xsl:value-of select="$TipoFattura/FatturaElettronicaHeader/DatiTrasmissione/FormatoTrasmissione" />
                  </span>

                  <label class= "headerLabel">&#160;&#160;Trasmittente:&#160;</label>
                  <span >
                    <xsl:value-of select="$TipoFattura/FatturaElettronicaHeader/DatiTrasmissione/IdTrasmittente/IdPaese" />
                    <xsl:value-of select="$TipoFattura/FatturaElettronicaHeader/DatiTrasmissione/IdTrasmittente/IdCodice" />
                  </span>

                  <label class= "headerLabel" >&#160;&#160;&#160;Progr.Invio:&#160;</label>
                  <span >
                    <xsl:value-of select="$TipoFattura/FatturaElettronicaHeader/DatiTrasmissione/ProgressivoInvio" />
                  </span>


                  <label class= "headerLabel" >&#160;&#160;&#160;Cod.Dest.:&#160;</label>
                  <span >
                    <xsl:value-of select="$TipoFattura/FatturaElettronicaHeader/DatiTrasmissione/CodiceDestinatario" />
                  </span>
